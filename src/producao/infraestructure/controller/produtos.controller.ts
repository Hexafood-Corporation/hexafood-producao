...
import { FindAllProdutosUseCase } from 'src/producao/core/application/usecases/produtoUseCase/find.all.produtos.usecase';
import { UpdateProdutoUseCase } from 'src/producao/core/application/usecases/produtoUseCase/update.produto.usecase';
import { DeleteProdutoUseCase } from 'src/producao/core/application/usecases/produtoUseCase/delete.produto.usecase';
import { InputProdutoDto } from 'src/producao/core/application/usecases/produtoUseCase/produto.dto';
import { CreateProdutoUseCase } from 'src/producao/core/application/usecases/produtoUseCase/create.produto.usecase';
import { FindByCategoriaProdutoUseCase } from 'src/producao/core/application/usecases/produtoUseCase/find.by.categoria.produto.usecase';
...
export class ProdutosController {
  constructor(
    ...
    private readonly findByIdCategoriaProdutoUseCase: FindByCategoriaProdutoUseCase,
  ...
  async findByIdCategoria(
    ...
    return await this.findByIdCategoriaProdutoUseCase.execute(id_categoria);
  }
